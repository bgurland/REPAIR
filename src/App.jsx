  ...
  return (
    <div style={{ fontFamily: "Georgia, serif", maxWidth: 700, margin: "0 auto", padding: 32, color: "#1a2e3b" }}>
      ...
      <div style={{ marginBottom: 24 }}>
        ...
        {scores.impactDone
          ? (<div><div style={{ fontSize: 16, color: "#1a2e3b", lineHeight: 1.6, marginBottom: 10 }}>{impactSummaryText(scores.impact)}</div></div>)
      ...
      {showPDF && (
        <div style={{ position: "fixed", inset: 0, zIndex: 300, background: C.bg, overflowY: "auto" }}>
          <div style={{ padding: 16 }}>
            ...
            <button onClick={() => window.print()} style={{ background: C.teal, color: "#fff", border: "none", borderRadius: 14, padding: "16px 24px", fontSize: 17, fontWeight: 700, fontFamily: "Georgia, serif", cursor: "pointer", minHeight: 54, marginBottom: 16 }}>🖨️ Print / Save as PDF</button>
